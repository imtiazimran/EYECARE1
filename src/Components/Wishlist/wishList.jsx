      ...
      hidden sm:block w-[97%] "
          >
            <button
              ...
              className=" flex  align  border border-red-700 text-2xl justify-evenly  w-full p-3 "
            >
              <div className="flex">
                <FaFilter className="" />
              ...
              <div className=" flex">
                <p className=" text-[23px] ml-6 low border   border-blue-300 flex">
                  Low To High
                </p>
                <p className=" text-[23px] ml-6 low border   border-blue-300 flex">
                  High To low
