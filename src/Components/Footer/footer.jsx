        ...
        <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
          <div className="sm:col-span-2">
            ...
            <div className="mt-6 lg:max-w-sm">
              <p className="text-sm text-gray-800">
                ...
                trends in online eyeglasses and sunglasses. We are dedicated to
                helping you protect your eyes and express your style with a
                curated collection of eyewear thats not only fashionable but
                also designed with your vision health in mind. At EyeCare.com,
                we believe that your eyes deserve the best, and were here to
                provide it.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="mt-4 text-sm text-gray-500">
              Connect with us Also Scoial Media
            </p>
          </div>
        </div>
